...
// Could be merged into shared interface with GetFollowers to reduce duplication,
// but I don't think they should use same interface with increased complexity,
// for the sake of deduplication. Writing *similar* code twice doesn't bite.
